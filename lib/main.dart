...
import 'package:streaming_test_null_safety/call_sample.dart';
...
class _MyHomeState extends State<MyHome> {
  ...
  void initState() {
    ...
    _textSessionController = TextEditingController(text: 'Session');
    _textUserNameController =
        TextEditingController(text: 'Participante${Random().nextInt(1000)}');
